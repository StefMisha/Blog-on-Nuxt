  ...
  <el-table
    ...
    <el-table-column
      ...
      <template slot-scope="{row}">
        <el-tooltip effect="dark" content="Редактирование поста" placement="top">
          <el-button
            icon="el-icon-edit"
            type="primary"
            size="mini"
            @click="open(row._id)">Редактировать
          </el-button>
        </el-tooltip>
        <el-tooltip effect="dark" content="Удалить поста" placement="top">
          <el-button
            icon="el-icon-delete"
            size="mini"
            type="danger"
            @click="remove(row._id)">Удалить
          </el-button>
        </el-tooltip>
      </template>
    </el-table-column>
